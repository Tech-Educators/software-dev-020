export const plants = [
  ...
  export function findPlant(id) {
    // .find takes a callback function - and checks each index of the array - so we check if plants[0].id is the same as the id we gave to the function 
    return plants.find(plant => plant.id == id)
  }

//   console.log(findPlant(4));
