...
export default async function Page() {
    ...
    const userReviews = (await db.query(`SELECT review.*, books.title FROM review INNER JOIN books ON review.book_id = books.id WHERE review.user_id = $1 `, [userInfo.id])).rows
